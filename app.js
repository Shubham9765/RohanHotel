...
function printReceipt() {
    ...
    confirmBtn.addEventListener("click", () => {
        ...
        const receipt = `
            ...
            -----------------------
            ${currentOrder.map(item => `${item.name} x${item.qty} - Rs.${(item.price * item.qty).toFixed(2)}`).join("\n")}
            -----------------------
        ...
        reportList.innerHTML = `
            <div class="report-summary modern-summary">
                <div class="summary-item">
                    ...
                    <span class="summary-value">Rs.${totalDailyAmount}</span>
                </div>
                <div class="summary-item">
                ...
                <div class="summary-item">
                    ...
                    <span class="summary-value">Rs.${avgDailySales}</span>
                </div>
                <div class="summary-item">
                    <span class="summary-label">Most Sold Item</span>
                    <span class="summary-value">${mostSoldItem}</span>
            ...
            <div class="report-grid">
                ${reports
                    ...
                    <div class="report-card">
                        ...
                        <div class="report-body">
                            <p><strong>Total Sales:</strong> Rs.${report.totalSales}</p>
